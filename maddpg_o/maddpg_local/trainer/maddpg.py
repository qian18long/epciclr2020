...
from maddpg_local.common.distributions import make_pdtype
from maddpg_local import AgentTrainer
from maddpg_local.trainer.replay_buffer import ReplayBuffer
...
class MADDPGAgentTrainer(AgentTrainer):
    def __init__(self, name, model, obs_shape_n, act_space_n, agent_index, args, reuse=None, local_q_func=False):
        self.name = name
